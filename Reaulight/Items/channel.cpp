...
ChannelR::ChannelR(int place, QObject *parent) : QObject{parent}
{
    this->place = place;
    this->value = 0;
...
ChannelG::ChannelG(int place, QObject *parent) : QObject{parent}
{
    this->place = place;
    this->value = 0;
...
ChannelG::ChannelB(int place, QObject *parent) : QObject{parent}
{
    this->place = place;
    this->value = 0;
